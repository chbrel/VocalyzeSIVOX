...
public class Random {
	 ...
	 */
	public static double unsignedRandom(final int n) {
	 ...
	 * 
	 * @param n
	 *            la borne inferieure et superieure de l'intervalle
	 * @return un double compris entre -n et n
	 */
	public static double random(final int n) {
		final double d = unsignedRandom(n);
	 ...
	 * @param n
	 *            le maximum possible pour le delta
	 * @return un int egal a i + delta avec 0 < delta < n
	 */
	public static int unsignedDelta(final int i, final int n) {
	 ...
	 */
	public static int delta(final int i, final int n) {
