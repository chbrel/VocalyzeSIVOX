...
public class SauvegardeProjetException extends SIVOXException {
	 ...
	 */
	public SauvegardeProjetException(final String message, final String messageSonore) {
	...
	public void printStackTrace() {
		System.out.println("Erreur SIVOX Sauvegarde de projet : " + this.messageErreur);
	}
	...
	public void printStackTrace(final PrintStream s) {
		s.println("Erreur SIVOX Sauvegarde de projet : " + this.messageErreur);
	}
	...
	public void printStackTrace(final PrintWriter w) {
		w.println("Erreur SIVOX Sauvegarde de projet : " + this.messageErreur);
	}
	...
	@Override
	public Object clone() {
		return (new SauvegardeProjetException(this.messageErreur, this.messageSonoreErreur));
	}
}
