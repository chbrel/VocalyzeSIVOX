...
public class ChantException extends SIVOXException {
	 ...
	 */
	public ChantException(final String message, final String messageSonore) {
	...
	public void printStackTrace() {
		System.out.println("Erreur SIVOX Chant : " + this.messageErreur);
	}
	...
	public void printStackTrace(final PrintStream s) {
		s.println("Erreur SIVOX Chant : " + this.messageErreur);
	}
	...
	public void printStackTrace(final PrintWriter w) {
		w.println("Erreur SIVOX Chant : " + this.messageErreur);
	}
	...
	@Override
	public Object clone() {
		return (new ChantException(this.messageErreur, this.messageSonoreErreur));
	}
}
