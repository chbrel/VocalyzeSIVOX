...
public class PlusDePhraseException extends SIVOXException {
	 ...
	 */
	public PlusDePhraseException(final String message, final String messageSonore) {
	...
	public void printStackTrace() {
		System.out.println("Erreur SIVOX Phrase : " + this.messageErreur);
	}
	...
	public void printStackTrace(final PrintStream s) {
		s.println("Erreur SIVOX Phrase : " + this.messageErreur);
	}
	...
	public void printStackTrace(final PrintWriter w) {
		w.println("Erreur SIVOX Phrase : " + this.messageErreur);
	}
	...
	@Override
	public Object clone() {
		return (new PlusDePhraseException(this.messageErreur, this.messageSonoreErreur));
	}
}
